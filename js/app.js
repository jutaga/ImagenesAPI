...
function mostrarAlerta(mensaje) {
    ...
    if (!existeAlerta) {
        ...
        alerta.classList.add('bg-red-100', 'border-red-400', 'text-red-700', 'px-4', 'py-3', 'rounded', 'mx-w-lg', 'mx-auto', 'mt-6', 'text-center');
...
function buscarImagenes() {
    ...
    const key = '30830727-96dbe881beaad6146392ad01c';
